...
if ($_GET['title']) :
?>
    <h1 style="text-align:center;color:red;">Стоимость товара <?= $_GET['title'] ?> успешно обновлена!</h1>
<?php
endif;
?>
...
<table style="text-align:center;margin: 0 auto;" border="1" width="700">
    ...
    while ($data = mysqli_fetch_assoc($res)) : ?>
        <tr>
            <td>
                <img width="150" height="150" src="../goods-img/<?= $data['img'] ?>" alt="">
            </td>
            <td>
                <?= $data['title'] ?>
            </td>
...
<div style="text-align: center; margin: 25px 0;">
    <a href="/admin/new-good.php">Добавить новый товар</a>
</div>